...
RSpec.describe ResultadosController, type: :controller do
  ...
  # ResultadosController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #edit" do
    it "returns a success response" do
      resultado = Resultado.create! valid_attributes
      get :edit, params: {id: resultado.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created resultado" do
        post :create, params: {resultado: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Resultado.last)
      end
    end

    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {resultado: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the resultado" do
        ...
        expect(response).to redirect_to(resultado)
      end
    end
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        resultado = Resultado.create! valid_attributes
        put :update, params: {id: resultado.to_param, resultado: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
